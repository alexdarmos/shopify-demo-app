...
var styles$1A = require('@shopify/react-utilities/styles');
...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '3.15.0';
}

var polarisVersion = '3.15.0';
...
function (_React$PureComponent) {
  ...
  _createClass(Avatar, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles.Avatar, styles[styles$1A.variationName('style', styleClass(nameString))], size && styles[styles$1A.variationName('size', size)], hasImage && !hasLoaded && styles.hidden, hasImage && styles.hasImage);
...
function Icon(_ref) {
  ...
  var className = styles$1A.classNames(styles$1.Icon, color && styles$1[styles$1A.variationName('color', color)], color && color !== 'white' && styles$1.isColored, backdrop && styles$1.hasBackdrop);
...
function Spinner(_ref) {
  ...
  var className = styles$1A.classNames(styles$2.Spinner, color && styles$2[styles$1A.variationName('color', color)], size && styles$2[styles$1A.variationName('size', size)]);
...
function Button(_ref) {
  ...
  var className = reactUtilities.classNames(styles$3.Button, primary && styles$3.primary, outline && styles$3.outline, destructive && styles$3.destructive, isDisabled && styles$3.disabled, loading && styles$3.loading, plain && styles$3.plain, monochrome && styles$3.monochrome, size && size !== DEFAULT_SIZE && styles$3[reactUtilities.variationName('size', size)], fullWidth && styles$3.fullWidth, icon && children == null && styles$3.iconOnly);
...
function (_React$PureComponent) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$4.Item, focused && styles$4['Item-focused'], button.props.plain && styles$4['Item-plain']);
      return React.createElement("div", {
        className: className,
...
function ButtonGroup(_ref) {
  ...
  var className = styles$1A.classNames(styles$4.ButtonGroup, segmented && styles$4.segmented, fullWidth && styles$4.fullWidth, connectedTop && styles$4.connectedTop);
...
function Item$1(_ref) {
  var children = _ref.children,
      fill = _ref.fill;
  var className = styles$1A.classNames(styles$5.Item, fill && styles$5['Item-fill']);
  return React.createElement("div", {
    className: className
  }, children);
}
...
function (_React$PureComponent) {
  ...
  _createClass(Stack, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$5.Stack, vertical && styles$5.vertical, spacing && styles$5[styles$1A.variationName('spacing', spacing)], distribution && styles$5[styles$1A.variationName('distribution', distribution)], alignment && styles$5[styles$1A.variationName('alignment', alignment)], wrap === false && styles$5.noWrap);
...
function Section(_ref) {
  var children = _ref.children,
      ...
      fullWidth = _ref.fullWidth;
  var className = styles$1A.classNames(styles$7.Section, subdued && styles$7['Section-subdued'], fullWidth && styles$7['Section-fullWidth']);
...
function (_React$PureComponent) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$7.Card, subdued && styles$7.subdued);
...
function TextStyle(_ref) {
  var variation = _ref.variation,
      children = _ref.children;
  var className = styles$1A.classNames(variation && styles$9[styles$1A.variationName('variation', variation)], variation === VariationValue.Code && styles$9.code);
...
function (_React$Component) {
  ...
  _createClass(Scrollable, [{
    ...
    value: function render() {
      ...
      var finalClassName = styles$1A.classNames(className, styles$c.Scrollable, vertical && styles$c.vertical, horizontal && styles$c.horizontal, topShadow && styles$c.hasTopShadow, bottomShadow && styles$c.hasBottomShadow);
...
function Badge(_ref) {
  var children = _ref.children,
      ...
      intl = _ref.polaris.intl;
  var className = styles$1A.classNames(styles$e.Badge, status && styles$e[styles$1A.variationName('status', status)], progress && styles$e[styles$1A.variationName('progress', progress)], size && size !== DEFAULT_SIZE$1 && styles$e[styles$1A.variationName('size', size)]);
  var progressMarkup;
...
function Item$2(_ref) {
  var id = _ref.id,
      ...
      active = _ref.active,
      role = _ref.role;
  var className = reactUtilities.classNames(styles$f.Item, disabled && styles$f.disabled, destructive && styles$f.destructive, active && styles$f.active);
...
function Checkbox(_ref) {
  var _ref$id = _ref.id,
      ...
      value = _ref.value,
      role = _ref.role;
  var className = styles$1A.classNames(styles$g.Checkbox, active && styles$g.active);
  return React.createElement("div", {
    className: className
...
function (_React$Component) {
  ...
  _createClass(Option, [{
    ...
    value: function render() {
      ...
      var singleSelectClassName = styles$1A.classNames(styles$h.SingleSelectOption, focused && styles$h.focused, disabled && styles$h.disabled, select && styles$h.select, active && styles$h.active);
      var multiSelectClassName = styles$1A.classNames(styles$h.Label, active && styles$h.active);
...
function Pane(_ref) {
  ...
  var className = styles$1A.classNames(styles$j.Pane, fixed && styles$j['Pane-fixed']);
...
function (_React$PureComponent) {
  ...
  _createClass(PositionedOverlay, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$k.PositionedOverlay, fixed && styles$k.fixed);
      return React.createElement("div", {
        className: className,
        style: style,
        ref: this.setOverlay
...
function (_React$PureComponent) {
  ...
  function PopoverOverlay() {
    ...
    _this.renderPopover = function (transitionStatus, overlayDetails) {
      ...
      var className = styles$1A.classNames(styles$j.Popover, positioning === 'above' && styles$j.positionedAbove, fullWidth && styles$j.fullWidth, measuring && styles$j.measuring);
      _this.transitionStatus = transitionStatus;
      var contentStyles = measuring ? undefined : {
        height: desiredHeight
      };
      var contentClassNames = styles$1A.classNames(styles$j.Content, fullHeight && styles$j['Content-fullHeight']);
...
function Label(_ref) {
  var children = _ref.children,
      id = _ref.id,
      hidden = _ref.hidden;
  var className = styles$1A.classNames(styles$l.Label, hidden && styles$l.hidden);
  return React.createElement("div", {
    className: className
...
function Labelled(_a) {
  ...
  var className = styles$1A.classNames(labelHidden && styles$n.hidden);
...
function (_React$PureComponent) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$o.Item, focused && styles$o['Item-focused'], position === ItemPosition.Primary ? styles$o['Item-primary'] : styles$o['Item-connection']);
      return React.createElement("div", {
        onBlur: this.handleBlur,
        onFocus: this.handleFocus,
        className: className
...
function (_React$PureComponent) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$p.TextField, Boolean(normalizedValue) && styles$p.hasValue, disabled && styles$p.disabled, readOnly && styles$p.readOnly, error && styles$p.error, multiline && styles$p.multiline, this.state.focus && styles$p.focus);
      ...
      var characterCountClassName = styles$1A.classNames(styles$p.CharacterCount, multiline && styles$p.AlignFieldBottom);
      ...
      var inputClassName = styles$1A.classNames(styles$p.Input, align && styles$p[styles$1A.variationName('Input-align', align)], suffix && styles$p['Input-suffixed'], clearButton && styles$p['Input-hasClearButton']);
...
function (_React$PureComponent) {
  ...
  _createClass(Banner, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$s.Banner, status && styles$s[styles$1A.variationName('status', status)], onDismiss && styles$s.hasDismiss, withinContentContainer ? styles$s.withinContentContainer : styles$s.withinPage);
      var id = uniqueID();
...
function Backdrop(props) {
  ...
  var className = reactUtilities.classNames(styles$t.Backdrop, belowNavigation && styles$t.belowNavigation, transparent && styles$t.transparent);
...
function TextContainer(_ref) {
  var spacing = _ref.spacing,
      children = _ref.children;
  var className = styles$1A.classNames(styles$v.TextContainer, spacing && styles$v[styles$1A.variationName('spacing', spacing)]);
  return React.createElement("div", {
    className: className
  }, children);
}
...
function CalloutCard(_ref) {
  ...
  var imageClassName = reactUtilities.classNames(styles$w.Image, onDismiss && styles$w.DismissImage);
...
function Choice(_ref) {
  var id = _ref.id,
      ...
      helpText = _ref.helpText,
      onClick = _ref.onClick;
  var className = styles$1A.classNames(styles$y.Choice, labelHidden && styles$y.labelHidden, disabled && styles$y.disabled);
...
function (_React$PureComponent) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      var wrapperClassName = styles$1A.classNames(styles$z.Checkbox, error && styles$z.error);
      ...
      var inputClassName = styles$1A.classNames(styles$z.Input, isIndeterminate && styles$z['Input-indeterminate']);
      return (
...
function ChoiceList(_ref) {
  ...
  var className = styles$1A.classNames(styles$B.ChoiceList, titleHidden && styles$B.titleHidden);
...
function (_React$Component) {
  ...
  _createClass(Collapsible, [{
    ...
    value: function render() {
      ...
      var wrapperClassName = styles$1A.classNames(styles$C.Collapsible, open && styles$C.open, animating && styles$C.animating, !animating && open && styles$C.fullyOpen);
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          children = _this$props.children;
      var searchClassName = styles$1A.classNames(styles$E.Search, visible && styles$E.visible);
      return React.createElement("div", {
        ref: this.node,
...
function (_React$Component) {
  ...
  _createClass(SearchField, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$F.SearchField, (focused || active) && styles$F.focused);
      return React.createElement("div", {
        className: className,
        onFocus: this.handleFocus,
        onBlur: this.handleBlur
...
function Link$1(_ref) {
  ...
  var className = reactUtilities.classNames(styles$H.Link, monochrome && styles$H.monochrome);
...
function (_React$PureComponent) {
  ...
  _createClass(TopBar, [{
    ...
    value: function render() {
      ...
      var focused = this.state.focused;
      var className = styles$1A.classNames(styles$L.NavigationIcon, focused && styles$L.focused);
...
function (_React$Component) {
  ...
  _createClass(Toast, [{
    ...
    value: function render() {
      ...
      var className = reactUtilities.classNames(styles$M.Toast, error && styles$M.error);
      return React.createElement("div", {
        className: className
      }, React.createElement(KeypressListener, {
        keyCode: exports.Key.Escape,
...
var toastClasses = {
  enter: styles$1A.classNames(styles$N.ToastWrapper, styles$N['ToastWrapper-enter']),
  enterDone: styles$1A.classNames(styles$N.ToastWrapper, styles$N['ToastWrapper-enter-done']),
  exit: styles$1A.classNames(styles$N.ToastWrapper, styles$N['ToastWrapper-exit'])
};
...
function Dialog(_a) {
  ...
  var classes = styles$1A.classNames(styles$P.Modal, large && styles$P.sizeLarge, limitHeight && styles$P.limitHeight);
...
var fadeUpClasses = {
  enter: styles$1A.classNames(styles$P.animateFadeUp, styles$P.entering),
  enterActive: styles$1A.classNames(styles$P.animateFadeUp, styles$P.entered),
  exit: styles$1A.classNames(styles$P.animateFadeUp, styles$P.exiting),
  exitActive: styles$1A.classNames(styles$P.animateFadeUp, styles$P.exited)
};
...
function DisplayText(_ref) {
  ...
  var className = styles$1A.classNames(styles$R.DisplayText, size && styles$R[styles$1A.variationName('size', size)]);
  return React.createElement(Element, {
    className: className
  }, children);
}
...
function CloseButton(_ref) {
  var _ref$title = _ref.title,
      ...
      onClick = _ref.onClick;
  var className = reactUtilities.classNames(styles$S.CloseButton, !title && styles$S.withoutTitle);
  return React.createElement("button", {
    onClick: onClick,
    className: className
  }, React.createElement(Icon$1, {
...
function Section$3(_ref) {
  ...
  var className = styles$1A.classNames(styles$U.Section, flush && styles$U.flush, subdued && styles$U.subdued);
  ...
  _createClass(Frame, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          intl = _this$props.polaris.intl;
      var navClassName = styles$1A.classNames(styles$X.Navigation, showMobileNavigation && styles$X['Navigation-visible']);
      ...
      var skipClassName = styles$1A.classNames(styles$X.Skip, skipFocused && styles$X.focused);
      ...
      var frameClassName = styles$1A.classNames(styles$X.Frame, navigation && styles$X.hasNav, topBar && styles$X.hasTopBar);
...
var navTransitionClasses = {
  enter: styles$1A.classNames(styles$X['Navigation-enter']),
  enterActive: styles$1A.classNames(styles$X['Navigation-enterActive']),
  enterDone: styles$1A.classNames(styles$X['Navigation-enterActive']),
  exit: styles$1A.classNames(styles$X['Navigation-exit']),
  exitActive: styles$1A.classNames(styles$X['Navigation-exitActive'])
};
var contextualSaveBarTransitionClasses = {
  enter: styles$1A.classNames(styles$X['ContextualSaveBar-enter']),
  enterActive: styles$1A.classNames(styles$X['ContextualSaveBar-enterActive']),
  enterDone: styles$1A.classNames(styles$X['ContextualSaveBar-enterActive']),
  exit: styles$1A.classNames(styles$X['ContextualSaveBar-exit']),
  exitActive: styles$1A.classNames(styles$X['ContextualSaveBar-exitActive'])
};
...
function Cell(_ref) {
  ...
  var className = styles$1A.classNames(styles$Y.Cell, fixed && styles$Y['Cell-fixed'], fixed && truncate && styles$Y['Cell-truncated'], header && styles$Y['Cell-header'], total && styles$Y['Cell-total'], footer && styles$Y['Cell-footer'], numeric && styles$Y['Cell-numeric'], sortable && styles$Y['Cell-sortable'], sorted && styles$Y['Cell-sorted']);
  var headerClassName = styles$1A.classNames(header && styles$Y.Heading, header && contentType === 'text' && styles$Y['Heading-left']);
  var iconClassName = styles$1A.classNames(sortable && styles$Y.Icon);
  var style = {
...
function Navigation(_ref) {
  ...
  var pipMarkup = columnVisibilityData.map(function (column, index) {
    var className = styles$1A.classNames(styles$Y.Pip, column.isVisible && styles$Y['Pip-visible']);
    return React.createElement("div", {
      className: className,
...
function (_React$PureComponent) {
  ...
  function DataTable(props) {
    ...
    _this.defaultRenderRow = function (row, index) {
      var className = styles$1A.classNames(styles$Y.TableRow);
      var _this$props3 = _this.props,
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$Y.DataTable, collapsed && styles$Y.collapsed, footerContent && styles$Y.hasFooter);
      var wrapperClassName = styles$1A.classNames(styles$Y.TableWrapper, collapsed && styles$Y.collapsed);
      var footerClassName = styles$1A.classNames(footerContent && styles$Y.TableFoot);
...
function (_React$PureComponent) {
  ...
  _createClass(Day, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$Z.Day, selected && styles$Z['Day-selected'], disabled && styles$Z['Day-disabled'], today && styles$Z['Day-today'], (inRange || inHoveringRange) && !disabled && styles$Z['Day-inRange']);
...
function Weekday(_ref) {
  ...
  var className = styles$1A.classNames(styles$Z.Weekday, current && styles$Z['Weekday-current']);
  return React.createElement("div", {
...
function Month(_ref) {
  ...
  var className = styles$1A.classNames(styles$Z.Title, current && styles$Z['Month-current']);
...
function (_React$Component) {
  ...
  _createClass(FileUpload, [{
    ...
    value: function render() {
      ...
      var imageClasses = styles$1A.classNames(styles$$.Image, size && size === 'extraLarge' && styles$$.sizeExtraLarge, size && size === 'large' && styles$$.sizeLarge);
...
function (_React$Component) {
  ...
  _createClass(DropZone, [{
    ...
    value: function render() {
      ...
      var classes = styles$1A.classNames(styles$10.DropZone, outline && styles$10.hasOutline, (active || dragging) && styles$10.isDragging, error && styles$10.hasError, size && size === 'extraLarge' && styles$10.sizeExtraLarge, size && size === 'large' && styles$10.sizeLarge, size && size === 'medium' && styles$10.sizeMedium, size && size === 'small' && styles$10.sizeSmall);
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          secondaryAction = _this$props.secondaryAction,
          footerContent = _this$props.footerContent;
      var className = styles$1A.classNames(styles$12.EmptyState, imageContained && styles$12.imageContained);
...
function ExceptionList(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    ...
    var itemClasses = styles$1A.classNames(styles$14.Item, status && styles$14[styles$1A.variationName('status', status)]);
...
function Group(_ref) {
  var children = _ref.children,
      ...
      title = _ref.title,
      helpText = _ref.helpText;
  var className = styles$1A.classNames(condensed ? styles$16.condensed : styles$16.grouped);
...
function Section$4(_ref) {
  ...
  var className = styles$1A.classNames(styles$18.Section, secondary && styles$18['Section-secondary'], fullWidth && styles$18['Section-fullWidth'], oneHalf && styles$18['Section-oneHalf'], oneThird && styles$18['Section-oneThird']);
  return React.createElement("div", {
    className: className
  }, children);
}
...
function (_React$PureComponent) {
  ...
  _createClass(ContentList, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$19.List, type && styles$19[styles$1A.variationName('type', type)]);
...
function Indicator(_ref) {
  ...
  var className = styles$1A.classNames(styles$1a.Indicator, pulse && styles$1a.pulseIndicator);
  return React.createElement("span", {
    className: className
  });
}
...
function (_React$Component) {
  ...
  _createClass(BaseItem, [{
    ...
    value: function render() {
      ...
      if (url == null) {
        var _className = styles$1A.classNames(styles$1b.Item, disabled && styles$1b['Item-disabled']);
      ...
      var itemClassName = styles$1A.classNames(styles$1b.Item, disabled && styles$1b['Item-disabled'], selected && subNavigationItems.length === 0 && styles$1b['Item-selected'], showExpanded && styles$1b.subNavigationActive);
      ...
      var className = styles$1A.classNames(styles$1b.ListItem, secondaryAction && styles$1b['ListItem-hasAction']);
      return React.createElement("li", {
        className: className
      }, React.createElement(UnstyledLink$1, {
        url: url,
...
function (_React$Component) {
  ...
  _createClass(Section, [{
    ...
    value: function render() {
      ...
      var expanded = this.state.expanded;
      var className = styles$1A.classNames(styles$1b.Section, separator && styles$1b['Section-withSeparator'], fill && styles$1b['Section-fill']);
      ...
      var toggleClassName = styles$1A.classNames(styles$1b.Item, styles$1b.RollupToggle);
...
function (_React$PureComponent) {
  ...
  function TooltipOverlay() {
    ...
    _this.renderTooltip = function (overlayDetails) {
      ...
      var containerClassName = styles$1A.classNames(styles$1c.Tooltip, light && styles$1c.light, measuring && styles$1c.measuring, positioning === 'above' && styles$1c.positionedAbove);
      var contentStyles = measuring ? undefined : {
...
function Pagination(_ref) {
  ...
  var className = reactUtilities.classNames(styles$1d.Pagination, plain && styles$1d.plain);
  var previousClassName = reactUtilities.classNames(styles$1d.Button, styles$1d.PreviousButton);
  var nextClassName = reactUtilities.classNames(styles$1d.Button, styles$1d.NextButton);
...
function Action(_ref) {
  ...
  var className = reactUtilities.classNames(styles$1e.Action, disabled && styles$1e.disabled, icon && children == null && styles$1e.iconOnly);
  return React.createElement("button", {
    key: children,
    className: className,
    onClick: onAction,
...
function (_React$PureComponent) {
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$1h.Page, fullWidth && styles$1h.fullWidth, singleColumn && styles$1h.singleColumn);
...
function (_React$PureComponent) {
  ...
  _createClass(RangeSlider, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$1j.RangeSlider, error && styles$1j.error, disabled && styles$1j.disabled);
      return React.createElement(Labelled, {
        id: id,
        label: label,
        error: error,
        ...
        className: styles$1j.InputWrapper
      }, React.createElement("input", {
        type: "range",
...
function Select(_ref) {
  ...
  var className = styles$1A.classNames(styles$1k.Select, error && styles$1k.error, disabled && styles$1k.disabled);
  ...
  var inlineLabelMarkup = labelInline && React.createElement("span", {
    className: styles$1k.InlineLabel
  }, label);
  ...
  var contentMarkup = React.createElement("div", {
    ...
    className: styles$1k.SelectedOption
...
function CheckableButton(_ref) {
  var accessibilityLabel = _ref.accessibilityLabel,
      ...
      disabled = _ref.disabled;
  var className = plain ? styles$1A.classNames(styles$1l.CheckableButton, styles$1l['CheckableButton-plain']) : styles$1A.classNames(styles$1l.CheckableButton, selectMode && styles$1l['CheckableButton-selectMode'], selected && styles$1l['CheckableButton-selected'], measuring && styles$1l['CheckableButton-measuring']);
  return React.createElement("div", {
    className: className,
    onClick: onToggleAll
  }, React.createElement("div", {
    className: styles$1l.Checkbox
  ...
  _createClass(BulkActionButton, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          disabled = _this$props.disabled;
      var disclosureIconMarkup = disclosure ? React.createElement("span", {
        className: styles$1m.ActionIcon
      }, React.createElement(Icon$1, {
        source: polarisIcons.CaretDownMinor
      })) : null;
      var contentMarkup = disclosureIconMarkup ? React.createElement("span", {
        className: styles$1m.ActionContent
      ...
      if (url) {
        return React.createElement(UnstyledLink$1, {
          ...
          url: url,
          onMouseUp: handleMouseUpByBlurring,
          className: styles$1m.Button,
          "aria-label": accessibilityLabel
        }, contentMarkup);
      }

      var className = reactUtilities.classNames(styles$1m.Button, disabled && styles$1m.disabled);
      return React.createElement("button", {
        className: className,
        onClick: onAction,
        onMouseUp: handleMouseUpByBlurring,
...
var slideClasses = {
  appear: styles$1A.classNames(styles$1m.Slide, styles$1m['Slide-appear']),
  appearActive: styles$1A.classNames(styles$1m.Slide, styles$1m['Slide-appearing']),
  enter: styles$1A.classNames(styles$1m.Slide, styles$1m['Slide-enter']),
  enterActive: styles$1A.classNames(styles$1m.Slide, styles$1m['Slide-entering']),
  exit: styles$1A.classNames(styles$1m.Slide, styles$1m['Slide-exit'])
};
var BulkActions =
/*#__PURE__*/
function (_React$PureComponent) {
  ...
  _createClass(BulkActions, [{
    ...
    value: function render() {
      ...
      var paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? React.createElement("div", {
        className: styles$1m.PaginatedSelectAll
      }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
      var cancelButtonClassName = styles$1A.classNames(styles$1m.Button, styles$1m['Button-cancel'], disabled && styles$1m.disabled);
      ...
      var smallScreenGroup = React.createElement(reactTransitionGroup.Transition, {
        ...
        var smallScreenGroupClassName = styles$1A.classNames(styles$1m.Group, styles$1m['Group-smallScreen'], styles$1m["Group-".concat(status)]);
        return React.createElement("div", {
          className: smallScreenGroupClassName
        }, React.createElement("div", {
          className: styles$1m.ButtonGroup
        }, React.createElement(reactTransitionGroup.CSSTransition, {
          "in": selectMode,
          timeout: tokens.durationBase,
      ...
      var largeScreenGroup = React.createElement(reactTransitionGroup.Transition, {
        ...
        var largeScreenGroupClassName = styles$1A.classNames(styles$1m.Group, styles$1m['Group-largeScreen'], !measuring && styles$1m["Group-".concat(status)], measuring && styles$1m['Group-measuring']);
        return React.createElement("div", {
...
function Tag(_ref) {
  var children = _ref.children,
      ...
      intl = _ref.polaris.intl;
  var className = reactUtilities.classNames(disabled && styles$1n.disabled, styles$1n.Tag);
  ...
  _createClass(DateSelector, [{
    ...
    value: function render() {
      ...
      var datePredicateMarkup = showDatePredicate && React.createElement(React.Fragment, null, React.createElement("div", {
        className: styles$1o.DateTextField
        ...
        className: styles$1o.DatePicker
  ...
  _createClass(FilterControl, [{
    ...
    value: function render() {
      ...
      var appliedFiltersMarkup = appliedFilters.map(function (appliedFilter) {
        ...
        return React.createElement("li", {
          className: styles$1p.AppliedFilter,
          key: filterId
      ...
      var appliedFiltersWrapper = appliedFilters.length > 0 ? React.createElement("ul", {
        className: styles$1p.AppliedFilters
    ...
    value: function render() {
      ...
      if (media || selectable) {
        ownedMarkup = React.createElement("div", {
          className: styles$1q.Owned
        }, handleMarkup, mediaMarkup);
      }

      var className = styles$1A.classNames(styles$1q.Item, focused && styles$1q.focused, selectable && styles$1q.selectable, selected && styles$1q.selected, selectMode && styles$1q.selectMode, persistActions && styles$1q.persistActions, focusedInner && styles$1q.focusedInner);
      ...
      if (shortcutActions && !loading) {
        if (persistActions) {
          ...
          disclosureMarkup = React.createElement("div", {
            className: styles$1q.Disclosure,
            onClick: stopPropagation$1
          }, React.createElement(Popover, {
            activator: React.createElement(Button$1, {
  ...
  _createClass(ResourceList, [{
    ...
    value: function render() {
      ...
      var filterControlMarkup = filterControl ? React.createElement("div", {
        className: styles$1r.FiltersWrapper
      }, filterControl) : null;
      var bulkActionsMarkup = this.selectable ? React.createElement("div", {
        className: styles$1r.BulkActionsWrapper
      ...
      var sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? React.createElement("div", {
        className: styles$1r.SortWrapper
      ...
      var alternateToolMarkup = alternateTool && !sortingSelectMarkup ? React.createElement("div", {
        className: styles$1r.AlternateToolWrapper
      }, alternateTool) : null;
      var headerTitleMarkup = React.createElement("div", {
        className: styles$1r.HeaderTitleWrapper
      }, this.headerTitle);
      var selectButtonMarkup = this.selectable ? React.createElement("div", {
        className: styles$1r.SelectButtonWrapper
      }, React.createElement(Button$1, {
        disabled: selectMode,
      ...
      var checkableButtonMarkup = this.selectable ? React.createElement("div", {
        className: styles$1r.CheckableButtonWrapper
      ...
      var headerWrapperOverlay = loading ? React.createElement("div", {
        className: styles$1r['HeaderWrapper-overlay']
      }) : null;
      ...
      var headerMarkup = !showEmptyState && (showHeader || needsHeader) && this.listRef.current && React.createElement("div", {
        className: styles$1r.HeaderOuterWrapper
      }, React.createElement(Sticky, {
        boundingElement: this.listRef.current
      }, function (isSticky) {
        var headerClassName = styles$1A.classNames(styles$1r.HeaderWrapper, sortOptions && sortOptions.length > 0 && !alternateTool && styles$1r['HeaderWrapper-hasSort'], alternateTool && styles$1r['HeaderWrapper-hasAlternateTool'], _this2.selectable && styles$1r['HeaderWrapper-hasSelect'], loading && styles$1r['HeaderWrapper-disabled'], _this2.selectable && selectMode && styles$1r['HeaderWrapper-inSelectMode'], isSticky && styles$1r['HeaderWrapper-isSticky']);
        return React.createElement("div", {
          className: headerClassName
        }, headerWrapperOverlay, React.createElement("div", {
          className: styles$1r.HeaderContentWrapper
      ...
      var emptyStateMarkup = showEmptyState ? React.createElement("div", {
        className: styles$1r.EmptySearchResultWrapper
      ...
      var loadingOverlay = loading ? React.createElement(React.Fragment, null, React.createElement("div", {
        className: styles$1r.SpinnerContainer,
        style: spinnerStyle
      }, React.createElement(Spinner$1, {
        size: spinnerSize,
        accessibilityLabel: "Items are loading"
      })), React.createElement("div", {
        className: styles$1r.LoadingOverlay
      })) : null;
      var className = styles$1A.classNames(styles$1r.ItemWrapper, loading && styles$1r['ItemWrapper-isLoading']);
      var loadingWithoutItemsMarkup = loading && !this.itemsExist() ? React.createElement("div", {
        className: className,
        tabIndex: -1
      }, loadingOverlay) : null;
      var resourceListClassName = styles$1A.classNames(styles$1r.ResourceList, loading && styles$1r.disabledPointerEvents);
      ...
      return React.createElement(Provider$3, {
        ...
        className: styles$1r.ResourceListWrapper
...
var BOTTOM_CLASS_NAMES = {
  enter: styles$1A.classNames(styles$1s.Bottom, styles$1s.enterBottom),
  enterActive: styles$1A.classNames(styles$1s.Bottom, styles$1s.enterBottomActive),
  exit: styles$1A.classNames(styles$1s.Bottom, styles$1s.exitBottom),
  exitActive: styles$1A.classNames(styles$1s.Bottom, styles$1s.exitBottomActive)
};
var RIGHT_CLASS_NAMES = {
  enter: styles$1A.classNames(styles$1s.Right, styles$1s.enterRight),
  enterActive: styles$1A.classNames(styles$1s.Right, styles$1s.enterRightActive),
  exit: styles$1A.classNames(styles$1s.Right, styles$1s.exitRight),
  exitActive: styles$1A.classNames(styles$1s.Right, styles$1s.exitRightActive)
};
var Sheet =
/*#__PURE__*/
function (_React$Component) {
...
function (_React$PureComponent) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var className = styles$1A.classNames(styles$1t.Tab, selected && styles$1t['Tab-selected']);
      var tabIndex;
      ...
      return React.createElement("li", {
        role: "presentation",
        className: styles$1t.TabContainer,
        ref: this.setNode
      }, markup);
    }
  }]);
...
function (_React$PureComponent) {
  ...
  _createClass(TabMeasurer, [{
    ...
    value: function render() {
      ...
      var classname = styles$1A.classNames(styles$1t.Tabs, styles$1t.TabMeasurer);
      return React.createElement("div", {
        className: classname,
        ref: this.setContainerNode
      }, React.createElement(EventListener, {
...
function (_React$PureComponent) {
  ...
  function Tabs() {
    ...
    _this.handleFocus = function (event) {
      ...
      if (target.classList.contains(styles$1t.Tab) || target.classList.contains(styles$1t.Item)) {
        var tabToFocus = -1;
      ...
      if (target.classList.contains(styles$1t.DisclosureActivator)) {
        return;
      ...
      if (!relatedTarget.classList.contains(styles$1t.Tab) && !relatedTarget.classList.contains(styles$1t.Item) && !relatedTarget.classList.contains(styles$1t.DisclosureActivator)) {
        _this.setState({
          tabToFocus: selected
        });
      }
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var classname = styles$1A.classNames(styles$1t.Tabs, fitted && styles$1t.fitted, disclosureActivatorVisible && styles$1t.fillSpace);
      var disclosureTabClassName = styles$1A.classNames(styles$1t.DisclosureTab, disclosureActivatorVisible && styles$1t['DisclosureTab-visible']);
      var activator = React.createElement("button", {
        tabIndex: -1,
        className: styles$1t.DisclosureActivator,
...
function Thumbnail(_ref) {
  var source = _ref.source,
      ...
      _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = styles$1A.classNames(styles$1u.Thumbnail, size && styles$1u[styles$1A.variationName('size', size)]);
  return React.createElement("span", {
    className: className
  }, React.createElement(Image, {
    alt: alt,
    source: source,
    className: styles$1u.Image
  }));
}
...
function SkeletonDisplayText(_ref) {
  var _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = styles$1A.classNames(styles$1v.DisplayText, size && styles$1v[styles$1A.variationName('size', size)]);
  return React.createElement("div", {
    className: className
  });
}
  ...
  _createClass(SkeletonPage, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          breadcrumbs = _this$props.breadcrumbs,
          intl = _this$props.polaris.intl;
      var className = styles$1A.classNames(styles$1x.Page, fullWidth && styles$1x.fullWidth, singleColumn && styles$1x.singleColumn);
      var headerClassName = styles$1A.classNames(styles$1x.Header, breadcrumbs && styles$1x['Header-hasBreadcrumbs'], secondaryActions && styles$1x['Header-hasSecondaryActions']);
...
function SkeletonThumbnail(_ref) {
  var _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = styles$1A.classNames(styles$1y.SkeletonThumbnail, size && styles$1y[styles$1A.variationName('size', size)]);
  return React.createElement("div", {
    className: className
  });
}
...
function ProgressBar(_ref) {
  var _ref$progress = _ref.progress,
      ...
      size = _ref$size === void 0 ? 'medium' : _ref$size,
      intl = _ref.polaris.intl;
  var className = styles$1A.classNames(styles$1z.ProgressBar, size && styles$1z[styles$1A.variationName('size', size)]);
