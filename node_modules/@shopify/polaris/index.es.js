...
import { noop as noop$1, createUniqueIDFactory } from '@shopify/javascript-utilities/other';
...
function createThemeContext(theme) {
  ...
  var _theme$logo = theme.logo,
      ...
      subscribe = _theme$subscribe === void 0 ? noop$1 : _theme$subscribe,
      _theme$unsubscribe = theme.unsubscribe,
      unsubscribe = _theme$unsubscribe === void 0 ? noop$1 : _theme$unsubscribe;
  return {
    polarisTheme: {
      logo: logo,
      subscribe: subscribe,
...
function createAppProviderContext() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      subscribe = _ref$subscribe === void 0 ? noop$1 : _ref$subscribe,
      _ref$unsubscribe = _ref.unsubscribe,
      unsubscribe = _ref$unsubscribe === void 0 ? noop$1 : _ref$unsubscribe;
...
function Backdrop(props) {
  ...
  var className = classNames$1(styles$t.Backdrop, belowNavigation && styles$t.belowNavigation, transparent && styles$t.transparent);
  ...
  _createClass(Day, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          onHover = _this$props$onHover === void 0 ? noop$1 : _this$props$onHover,
          _this$props$onFocus = _this$props.onFocus,
          onFocus = _this$props$onFocus === void 0 ? noop$1 : _this$props$onFocus,
          selected = _this$props.selected,
      ...
      var handleClick = onClick && !disabled ? onClick.bind(null, day) : noop$1;
...
function Month(_ref) {
  var focusedDate = _ref.focusedDate,
      ...
      onHover = _ref$onHover === void 0 ? noop$1 : _ref$onHover,
...
function Pagination(_ref) {
  ...
  var className = classNames$1(styles$1d.Pagination, plain && styles$1d.plain);
  var previousClassName = classNames$1(styles$1d.Button, styles$1d.PreviousButton);
  var nextClassName = classNames$1(styles$1d.Button, styles$1d.NextButton);
...
function Action(_ref) {
  ...
  var className = classNames$1(styles$1e.Action, disabled && styles$1e.disabled, icon && children == null && styles$1e.iconOnly);
  return createElement("button", {
    key: children,
    className: className,
    onClick: onAction,
...
function (_React$PureComponent) {
  ...
  _createClass(RangeSlider, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1j.RangeSlider, error && styles$1j.error, disabled && styles$1j.disabled);
      return createElement(Labelled, {
        id: id,
        label: label,
        error: error,
...
function Select(_ref) {
  ...
  var className = classNames(styles$1k.Select, error && styles$1k.error, disabled && styles$1k.disabled);
...
function CheckableButton(_ref) {
  var accessibilityLabel = _ref.accessibilityLabel,
      ...
      disabled = _ref.disabled;
  var className = plain ? classNames(styles$1l.CheckableButton, styles$1l['CheckableButton-plain']) : classNames(styles$1l.CheckableButton, selectMode && styles$1l['CheckableButton-selectMode'], selected && styles$1l['CheckableButton-selected'], measuring && styles$1l['CheckableButton-measuring']);
  return createElement("div", {
    className: className,
    onClick: onToggleAll
  }, createElement("div", {
...
function (_React$PureComponent) {
  ...
  _createClass(BulkActionButton, [{
    ...
    value: function render() {
      ...
      var className = classNames$1(styles$1m.Button, disabled && styles$1m.disabled);
      return createElement("button", {
        className: className,
        onClick: onAction,
        onMouseUp: handleMouseUpByBlurring,
...
var slideClasses = {
  appear: classNames(styles$1m.Slide, styles$1m['Slide-appear']),
  appearActive: classNames(styles$1m.Slide, styles$1m['Slide-appearing']),
  enter: classNames(styles$1m.Slide, styles$1m['Slide-enter']),
  enterActive: classNames(styles$1m.Slide, styles$1m['Slide-entering']),
  exit: classNames(styles$1m.Slide, styles$1m['Slide-exit'])
};
var BulkActions =
/*#__PURE__*/
function (_React$PureComponent) {
  ...
  _createClass(BulkActions, [{
    ...
    value: function render() {
      ...
      var cancelButtonClassName = classNames(styles$1m.Button, styles$1m['Button-cancel'], disabled && styles$1m.disabled);
      ...
      var smallScreenGroup = createElement(Transition, {
        ...
        var smallScreenGroupClassName = classNames(styles$1m.Group, styles$1m['Group-smallScreen'], styles$1m["Group-".concat(status)]);
        return createElement("div", {
      ...
      var largeScreenGroup = createElement(Transition, {
        ...
        var largeScreenGroupClassName = classNames(styles$1m.Group, styles$1m['Group-largeScreen'], !measuring && styles$1m["Group-".concat(status)], measuring && styles$1m['Group-measuring']);
        return createElement("div", {
...
function Tag(_ref) {
  var children = _ref.children,
      ...
      intl = _ref.polaris.intl;
  var className = classNames$1(disabled && styles$1n.disabled, styles$1n.Tag);
...
function (_React$Component) {
  ...
  function Item() {
    ...
    _this.handleKeyUp = function (event) {
      var _this$props3 = _this.props,
          ...
          onClick = _this$props3$onClick === void 0 ? noop$1 : _this$props3$onClick,
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1q.Item, focused && styles$1q.focused, selectable && styles$1q.selectable, selected && styles$1q.selected, selectMode && styles$1q.selectMode, persistActions && styles$1q.persistActions, focusedInner && styles$1q.focusedInner);
...
function (_React$Component) {
  ...
  _createClass(ResourceList, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1r.ItemWrapper, loading && styles$1r['ItemWrapper-isLoading']);
      var loadingWithoutItemsMarkup = loading && !this.itemsExist() ? createElement("div", {
        className: className,
        tabIndex: -1
      }, loadingOverlay) : null;
      var resourceListClassName = classNames(styles$1r.ResourceList, loading && styles$1r.disabledPointerEvents);
...
var BOTTOM_CLASS_NAMES = {
  enter: classNames(styles$1s.Bottom, styles$1s.enterBottom),
  enterActive: classNames(styles$1s.Bottom, styles$1s.enterBottomActive),
  exit: classNames(styles$1s.Bottom, styles$1s.exitBottom),
  exitActive: classNames(styles$1s.Bottom, styles$1s.exitBottomActive)
};
var RIGHT_CLASS_NAMES = {
  enter: classNames(styles$1s.Right, styles$1s.enterRight),
  enterActive: classNames(styles$1s.Right, styles$1s.enterRightActive),
  exit: classNames(styles$1s.Right, styles$1s.exitRight),
  exitActive: classNames(styles$1s.Right, styles$1s.exitRightActive)
};
var Sheet =
/*#__PURE__*/
function (_React$Component) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          onClick = _this$props$onClick === void 0 ? noop$1 : _this$props$onClick;
      var sharedProps = {
        id: id,
  ...
  function List() {
    ...
    _this.handleKeypress = function (event) {
      var _this$props$onKeyPres = _this.props.onKeyPress,
          onKeyPress = _this$props$onKeyPres === void 0 ? noop$1 : _this$props$onKeyPres;
      onKeyPress(event);
    };
...
function (_React$PureComponent) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1t.Tab, selected && styles$1t['Tab-selected']);
      var tabIndex;
...
function (_React$PureComponent) {
  ...
  _createClass(TabMeasurer, [{
    ...
    value: function render() {
      ...
      var classname = classNames(styles$1t.Tabs, styles$1t.TabMeasurer);
      return createElement("div", {
        className: classname,
        ref: this.setContainerNode
      }, createElement(EventListener, {
...
function (_React$PureComponent) {
  ...
  function Tabs() {
    ...
    _this.handleTabClick = function (id) {
      var _this$props3 = _this.props,
          ...
          onSelect = _this$props3$onSelect === void 0 ? noop$1 : _this$props3$onSelect;
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var classname = classNames(styles$1t.Tabs, fitted && styles$1t.fitted, disclosureActivatorVisible && styles$1t.fillSpace);
      var disclosureTabClassName = classNames(styles$1t.DisclosureTab, disclosureActivatorVisible && styles$1t['DisclosureTab-visible']);
...
function Thumbnail(_ref) {
  var source = _ref.source,
      ...
      _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = classNames(styles$1u.Thumbnail, size && styles$1u[variationName('size', size)]);
  return createElement("span", {
    className: className
  }, createElement(Image, {
    alt: alt,
  ...
  _createClass(SkeletonPage, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          breadcrumbs = _this$props.breadcrumbs,
          intl = _this$props.polaris.intl;
      var className = classNames(styles$1x.Page, fullWidth && styles$1x.fullWidth, singleColumn && styles$1x.singleColumn);
